			...
			<form method="POST">
				<div class="application" style="border-top: 2px solid #43a051">
					...
					<div class="app-body" style="padding-top: 30px; border-top: 1px solid #333">
						<ul class="app-form">
							...
							<li>
								...
								<input type="text" name="name" id="name" placeholder="이름" style="width: 100%; max-width: 200px" disabled="disabled" value="${principal.member.name }" required />
							</li>
							<li>
								<span class="subject">ㆍ 연락처</span>
								<input type="text" name="phone" id="phone" placeholder="연락처를 입력해 주세요." style="width: 100%; max-width: 200px" disabled="disabled" value="${principal.member.phone }" required>
							</li>
										
							<li>
								<span class="subject">ㆍ 출금계좌</span>
								<select name="bank" required style="width: 100%; max-width: 232px; margin-bottom: 2px;">
								...
								<input type="text" name="bank_number" id="bank_number" style="width: 100%; max-width: 200px;" required placeholder="계좌번호를 입력해 주세요.">
							</li>
						</ul>
						<div class="caution">
							<ul>
					...
					<div class="app-buttons">
						<button type="submit" class="">파트너 신청</button>
					</div>
				</div>
			</form>
		</div>
